...
możliwościami API i zawiera spostrzeżenia z sesji planowania.
...
Session Notes:
<session_notes>Nie powielaj ani nie powtarzaj żadnej pracy wykonanej w bloku myślenia.
/prompts/main/ui_session_notes.md
</session_notes>

Twoim zadaniem jest stworzenie szczegółowej architektury interfejsu użytkownika, która obejmuje niezbędne widoki,
mapowanie podróży użytkownika, strukturę nawigacji i kluczowe elementy dla każdego widoku. Projekt powinien uwzględniać
doświadczenie użytkownika, dostępność i bezpieczeństwo.
...
5. Określenie głównego celu i kluczowych informacji dla k12.2_FRONTED_podsumowanie_sesji_planistycznej.mdażdego widoku.
...
przed przejściem do następnego kroku. Ta sekcja może być dość długa. To w porządku, że ta sekcja może być dość długa.
...
w pliku 13.1_Frontend_ui_plan.md Nie powielaj ani nie powtarzaj żadnej pracy wykonanej w bloku myślenia.