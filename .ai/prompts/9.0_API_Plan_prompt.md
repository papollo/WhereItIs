...
Końcowy wynik powinien składać się wyłącznie z planu API w formacie markdown w języku angielskim, który zapiszesz w .ai/prompts/9.2_API_Plan_new_result.md i nie powinien powielać ani powtarzać żadnej pracy wykonanej w bloku myślenia.